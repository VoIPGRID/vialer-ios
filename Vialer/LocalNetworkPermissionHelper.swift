//
//  LocalNetworkPermissionHelper.swift
//  Vialer
//
//  Created by Chris Kontos on 10/12/2020.
...
///
/// There should be a proper API for this (r. 69157424) but Apple.. just requires the permission and does not provide an API to handle it..
///
...
@objc public class LocalNetworkPermissionHelper: NSObject {

    @objc public static func triggerLocalNetworkPrivacyAlert() {

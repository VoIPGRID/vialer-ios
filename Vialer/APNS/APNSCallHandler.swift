...
//        VialerLogWarning("---------//orp Start of Handle@APNSCallHandler:27 ---------")
//        // This is to temporarily ignore all other push notifications for this call, it can be removed when the middleware only sends one.
...
//
//        sleep(1)
//        VialerLogWarning("---------//orp Handle@APNSCallHandler:49 ---------")

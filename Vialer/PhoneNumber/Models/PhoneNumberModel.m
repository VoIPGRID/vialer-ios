...
+ (void)getCallNameFromPhoneNumber:(NSString *)phoneNumber withCompletion:(void (^ _Nullable)(PhoneNumberModel * _Nonnull))completion {
    PhoneNumberModel *model = [[[self class] alloc] init];
    BOOL success = [model getContactWithPhoneNumber:phoneNumber];

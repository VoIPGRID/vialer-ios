            ...
            SystemUser.current()?.updateUseOpus(audioQualityToStore, withCompletion: { (success, error) in
                if success {
                    ...
                    if updateSuccess {
                        ...
                        let alertController = UIAlertController(title: "Unable to activate", message: "Unable to activate the new audio quality setting", preferredStyle: .alert)
                    ...
                    let alertController = UIAlertController(title: "Unable to save", message: "Unable to save to remote", preferredStyle: .alert)
